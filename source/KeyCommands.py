...
# <tr><td>Enter</td><td>Inserts the search selection at the cursor's current position</td></tr>
# <tr><td>Ctrl+1</td><td>Inserts the search selection at the cursor's position in track 1</td></tr>
# <tr><td>Ctrl+2</td><td>Inserts the search selection at the cursor's position in track 2</td></tr>
# <tr><td>Ctrl+3</td><td>Inserts the search selection at the cursor's position in track 3</td></tr>
# <tr><td>Ctrl+4</td><td>Inserts the search selection at the cursor's position in track 4</td></tr>
# <tr><td>Ctrl+5</td><td>Inserts the search selection at the cursor's position in track 5</td></tr>
# <tr><td>Ctrl+6</td><td>Inserts the search selection at the cursor's position in track 6</td></tr>
# <tr><td>Ctrl+7</td><td>Inserts the search selection at the cursor's position in track 7</td></tr>
# <tr><td>Ctrl+8</td><td>Inserts the search selection at the cursor's position in track 8</td></tr>
# <tr><td>Ctrl+9</td><td>Inserts the search selection at the cursor's position in track 9</td></tr>
